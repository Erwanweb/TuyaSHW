...
# ---------------------------------------------
    def checkdevice(self):
        ...
        device = ("'"+str(self.DEVICE_ID)+"'", "'"+str(self.IP_ADDRESS)+"'", "'"+str(self.LOCAL_KEY)+"'", version=float(self.VERSION))
        Domoticz.Debug(f'checking : tinytuya.Device({device})')
        #d = tinytuya.Device("'"+str(self.DEVICE_ID)+"'", "'"+str(self.IP_ADDRESS)+"'", "'"+str(self.LOCAL_KEY)+"'", version=float(self.VERSION))
        d = tinytuya.Device(f'{device}')
