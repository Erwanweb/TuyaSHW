...
# ---------------------------------------------
    def checkdevice(self):
        ...
        d = tinytuya.Device('bfcc28923f9cbde8281cd4', '192.168.0.118', f"'{LOCAL_KEY}'", version=f"{VERSION}")
        ...
        #Domoticz.Debug("'{}', '{}', '{}', version={}").format(str(self.DEVICE_ID), str(self.LOCAL_KEY), str(self.IP_ADDRESS), float(self.VERSION)))
        #Domoticz.Debug('bfcc28923f9cbde8281cd4', '192.168.0.118', f"'{LOCAL_KEY}'", version=f"{VERSION}")
        data = d.status()

        # lecture et maj des valeurs des widgets
